...
\section{Wnioski}
Nie udało się zaobserwować na ekranie oscyloskopu sytuacji, w której wykresy się pokrywają (nie udało się osiągnąć dokładnie częstotliwości rezonansowej). Może to wynikać głównie z niskiej precyzji pokrętła do modulowania częstotliwości, oporów na kablach i płytce stykowej oraz z ograniczonej dokładności urządzeń pomiarowych.\\
Z tego samego powodu mogła pojawić się zaskakująco mała różnica pomiędzy $V_{rms}(1)$ źródła i $V_{rms}(2)$ rezystora dla częstotliwości poniżej rezonansowej (dla $5,15kHz$), która jest nawet mniejsza niż różnica dla częstotliwości rezonansowej $5,23kHz$.
